    ...
    <div class=" search-form input-group search-mobile"    >
        ...
        <form method="post" name="busqueaform" action="{{route('gourl')}}">
            ...
            <input  type="text"  autocomplete="off" name="busqueda"
                    ...
                    class="form-control search-field search-field-mobile input-busqueda"
                    placeholder="Busca productos aqui"
                    style="display: none; line-height: 35px;border:1px solid aliceblue;padding-right: 35px; width: 250px; height: 40px !important; ">
